...
from .tool_registry import RuntimeToolRegistry, ToolResult
...
class AgentExecutor:
    ...
    def _build_system_prompt(self, mode: AgentMode, context: dict) -> str:
        ...
        base = f"""You are Mirai Agent, an autonomous AI assistant. Your goal is to complete tasks by using available tools.
